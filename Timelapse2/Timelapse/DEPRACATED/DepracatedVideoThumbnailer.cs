...
#region VideoThumbnailer
//     THIS was a test to see if we can generate and store video thumbnails as files. However, we have since installed FFMPEG to get video thumbnails asyncronously, that is fast enough.
//     THus this was not pursued.Note that if we want to avoid using NRECO, the code fragment at the bottom shows how to get FFMPEG results directly. Not sure if its faster, but...
