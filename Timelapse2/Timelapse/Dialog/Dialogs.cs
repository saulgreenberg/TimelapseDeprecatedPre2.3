...
namespace Timelapse.Dialog
{
    public static class Dialogs
    {
        ...
        /// <summary>
        /// Tell the user hod duplicates work. Give them the opportunity to abort.
        /// </summary>
        public static bool? MenuEditHowDuplicatesWorkDialog(Window owner)
        {
            ...
            messageBox.Message.What += "For example, lets say you have a Choice box called 'Species' used to identify animals in your image." + Environment.NewLine;
            ...
            messageBox.Message.Hint += "\u2022 They can only be created in the main view, not in the overview." + Environment.NewLine;
            ...
            messageBox.Message.Hint += "\u2022 Importing a modified CSV file with duplicates into Timelapse may have undesired side effects. Duplicates with the same" + Environment.NewLine;
            messageBox.Message.Hint += "\u2022 relative path/file name will have their values overwritten by the last row with that relative path/file name in the CSV file."; 
